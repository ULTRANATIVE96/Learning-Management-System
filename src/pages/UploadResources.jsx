  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Upload Resources</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          {/* Uploader Card */}
          <div className="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 shadow-xl shadow-slate-100/50 dark:shadow-none">
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              {message && (
                <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 px-4 py-3 rounded-xl flex items-start gap-2.5 text-sm animate-fade-in">
              ...
              {error && (
                <div className="bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 px-4 py-3 rounded-xl flex items-start gap-2.5 text-sm animate-shake">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Target Folder</label>
              ...
              {/* Select module */}
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Associated Module</label>
                <div className="relative">
                  <select
              ...
              {/* File selection box */}
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">Document File</label>
                <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 hover:border-indigo-500 dark:hover:border-indigo-500 rounded-xl p-6 transition-all text-center relative cursor-pointer bg-slate-50/50 dark:bg-slate-950/20">
                  <input
                    type="file"
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-bold text-slate-950 dark:text-white mb-6 flex items-center justify-between">
              <span>Uploaded Resources in: <span className="text-indigo-600 dark:text-indigo-400">{selectedFolder}</span></span>
                ...
                {filesList.map((fileItem) => (
                  ...
                  >
                    <div className="flex items-center gap-3.5 overflow-hidden">
                      <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl flex items-center justify-center font-bold text-xs uppercase shrink-0">
                        {fileItem.type || 'PDF'}
                      </div>
                      <div className="overflow-hidden">
                        <p className="font-bold text-slate-900 dark:text-white text-sm truncate">{fileItem.name}</p>
